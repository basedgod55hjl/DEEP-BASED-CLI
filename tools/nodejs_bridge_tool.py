...
class NodeJSBridgeTool(BaseTool):
    ...
    def _ensure_node_environment(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                print("❌ Node.js not found - install Node.js to use bridge features")
        except (subprocess.TimeoutExpired, FileNotFoundError):
            self.node_available = False
            print("❌ Node.js not available - install Node.js to use bridge features")
...
async def example_stealth_scraper():
